...
```mermaid
graph TD;
    A([Start])-->B{{int harga, jumlah halaman buku, jumlah, double diskon = 0.1, total, bayar, jumlah diskon, char merk buku}};
    B{{int harga, jumlah halaman buku, jumlah, double diskon = 0.1, total, bayar, jumlah diskon, char merk buku}}-->C[/harga, jumlah, diskon/];
